...
export const PROJECTS: Project[] = [
    ...
    {
        title: "devkoutek.cz",
        description: "A discord place for czech developers. To show their projects and help each other.",
    ...
    {
        title: "casecobra",
        description: "E-commerce website for a company selling cases for mobile phones.",
